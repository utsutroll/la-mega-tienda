    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h4 class="modal-title text-light">Nueva Cuenta Bancaría</h4>
                ...
                <div wire:loading.remove wire:target="create">
                    <div class="flex">
                        ...
                        <div class="form-group flex-2">
                            ...
                            <input type="number" id="cedula" class="form-control" wire:model.defer="cedula" placeholder="Ingrese la Cédula, RIF o Pasaporte">    
                    ...
                    <div class="form-group">
                        <label for="bank_id" class="control-label">Tipo de Cuenta</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="account" class="form-control" wire:model.defer="account" placeholder="Ingrese el Nro. de Cuenta">    
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="phone" class="form-control" wire:model.defer="phone" placeholder="Ingrese el Nro de Teléfono">    
