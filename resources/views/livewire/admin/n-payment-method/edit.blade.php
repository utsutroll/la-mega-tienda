                ...
                <div wire:loading.remove>
                    <div class="flex">
                        ...
                        <div class="form-group flex-2">
                            ...
                            <input type="number" class="form-control" wire:model.defer="cedula" placeholder="Ingrese la Cédula, RIF o Pasaporte">    
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" wire:model.defer="account" placeholder="Ingrese el Nro. de Cuenta">    
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" wire:model.defer="phone" placeholder="Ingrese el Nro de Teléfono">    
