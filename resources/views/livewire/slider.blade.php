    ...
    <div id="carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img loading="lazy" class="img-responsive" src="{{asset('assets/images/slider.jpg')}}" alt="First slide">
            ...
            <div class="carousel-item">
                <img loading="lazy" class="img-responsive" src="{{asset('assets/images/slider1.jpg')}}" alt="Second slide">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img loading="lazy" class="img-responsive" src="{{asset('assets/images/slider2.jpg')}}" alt="Third slide">
                <div class="carousel-caption d-none d-md-block">
